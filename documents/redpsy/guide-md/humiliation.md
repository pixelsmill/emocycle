...
-  Il m'a humilié publiquement en révélant ce secret de famille.

-  J'ai été humilié d'échouer alors que je pensais obtenir la première place.

-  Cela m'a humilié de devoir lui faire des excuses.

-  Les prisonniers ont subi des traitements humiliants.
...
L'humiliation déclenchée par la crainte d'entacher notre image nécessite la présence d'un public. Elle provoque alors un sentiment de [honte](honte.html).
